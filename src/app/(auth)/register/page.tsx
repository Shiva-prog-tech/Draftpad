...
function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Auto-login then redirect to callbackUrl
    ...
    <div className="min-h-screen bg-[#0A0A0B] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#111113] border border-[#1F1F23] rounded-xl p-8">
          ...
          <p className="text-[#71717A] text-sm mb-6">Start collaborating in seconds</p>
          ...
          <div className="space-y-2 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 bg-[#0A0A0B] border border-[#1F1F23] hover:border-[#3F3F46] text-[#A1A1AA] hover:text-white rounded-lg px-4 py-2.5 text-sm font-medium transition-colors disabled:opacity-50"
            >
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[#3F3F46] text-xs">or</span>
            <div className="flex-1 h-px bg-[#1F1F23]" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-[#A1A1AA] text-xs font-medium uppercase tracking-wider mb-1.5 block">Name</label>
